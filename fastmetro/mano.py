# ---------------------------------------------------------------------------------------------- METRO (
# https://github.com/microsoft/MeshTransformer) Copyright (c) Microsoft Corporation. All Rights Reserved [see
# https://github.com/microsoft/MeshTransformer/blob/main/LICENSE for details] Licensed under the MIT license.
# ----------------------------------------------------------------------------------------------
"""
...
class MANO(nn.Module):
    ...
    def get_layer(self):
        return ManoLayer(mano_root=osp.join(self.mano_dir), flat_hand_mean=False,
